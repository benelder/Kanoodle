...
namespace UnitTestProject1
{
    ...
    public class ARotationTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void RotateA_1_DarkBlue()
        {
            var nodes = new Node[]
            {
                new Node(0,0,0),
            ...
            Assert.AreEqual(new Location(2, 0, 2), abs[4].Offset);
        }

        [TestMethod]
        public void RotateA_2_DarkBlue()
        {
            var nodes = new Node[]
            {
                new Node(0,0,0),
            ...
            Assert.AreEqual(new Location(1, 0, 0), abs[1].Offset);
            Assert.AreEqual(new Location(2, 0, 0), abs[2].Offset);
            Assert.AreEqual(new Location(2, -1, 1), abs[3].Offset);
            Assert.AreEqual(new Location(2, -2, 2), abs[4].Offset);
        }
